...
public class FarmerCommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer_comments);
      ...
      {
          super.onStart();
          FirebaseRecyclerAdapter<Farmer_Comments,CommentsViewHolder> firebaseRecyclerAdapter
                  =new FirebaseRecyclerAdapter<Farmer_Comments, CommentsViewHolder>
                  (
                    Farmer_Comments.class,
          ...
          {
              @Override
              protected void populateViewHolder(CommentsViewHolder viewHolder, Farmer_Comments model, int position)
              {
            ...
            PostsRef.child(RandomKey).updateChildren(commentsMap)
                    .addOnCompleteListener(new OnCompleteListener() {
                        ...
                        if(task.isSuccessful())
                               {
                                   Toast.makeText(FarmerCommentsActivity.this,"You have commented successfully",Toast.LENGTH_SHORT).show();
                                }
                                else
                        {
                            Toast.makeText(FarmerCommentsActivity.this,"Error occured ,try again ...",Toast.LENGTH_SHORT).show();
